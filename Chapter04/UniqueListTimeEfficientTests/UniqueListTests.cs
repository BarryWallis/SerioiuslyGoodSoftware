...
using UniqueListTimeEfficientLib;

namespace UniqueListTimeEfficientTests;
...
public class UniqueListTests
{
    ...
    public void Set_DuplicateElement_ReturnsFalse()
    {
        ...
        const int index = 1;
        bool success1 = uniqueList.Set(index, element);

        bool success2 = uniqueList.Set(index, element);
